...
public class TransactionController {
	...
	public Transaction createTransaction(@RequestBody Transaction transaction) {
		...
		/*
		 * if (newTransactionCreated |= true) return new
		 * ResponseEntity<Transaction>(newTransactionCreated, HttpStatus.IM_USED); else
		 * return new ResponseEntity<Transaction>(newTransactionCreated,
		 * HttpStatus.CREATED);
		 */
	}
